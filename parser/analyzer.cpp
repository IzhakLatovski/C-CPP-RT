...
analyzer_t::analyzer_t()
{
	...
	predefinedSet_m.insert(predefinedString,(predefinedString+sizeof(predefinedString)/sizeof(string)));
	operatorsSet_m.insert(operatorsString,(operatorsString+sizeof(operatorsString)/sizeof(string)));
	keywordsSet_m.insert(keywordsString,(keywordsString+sizeof(keywordsString)/sizeof(string)));
